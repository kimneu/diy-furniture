...
- `preise.js` – prices, thicknesses and panel sizes, including whole boards in fixed sizes for the Reduit (data only, updated by `tools/jumbo-preise.mjs --schreiben`)
